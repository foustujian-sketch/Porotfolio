...
@section('content')
    ...
    {{-- ======== 3D AVATAR HERO ======== --}}
    <section class="avatar-hero reveal">
        ...
        <div class="avatar-hero-text">
            ...
            <p style="font-size: 1rem; line-height: 1.75; color: #a1a1aa; max-width: 480px;">
                Information Systems student at <strong style="color: #e4e4e7;">Universitas Mulawarman</strong>, specializing in backend development and database optimization. I build full-scale web architectures with Laravel and cross-platform mobile apps with Flutter.
            </p>
        ...
        <div class="avatar-3d-container">
            {{-- 
                ...
                2. Create or remix a 3D character/avatar
                3. Click Export → Viewer → Copy the Public URL
                4. Paste it in the url="" attribute below
                
                Current: A public demo character from Spline community
            --}}
            <spline-viewer 
                url="https://prod.spline.design/6Wq1Q7YGyM-uBFai/scene.splinecode"
                loading-anim-type="spinner-small-dark"
                style="width: 100%; height: 100%;"
            ></spline-viewer>

            {{-- Fallback: real photo shown behind/beneath the 3D scene --}}
            <div class="avatar-3d-fallback">
                <img src="/images/avatar.png" alt="Abdurrahman Al Farisy">
                <span class="text-muted text-xs font-mono">Loading 3D avatar...</span>
            </div>
        </div>
